...
const useAccounts = (data: IUser[], page: number, rowsPerPage: number) => {
  return useMemo(() => {
...
export const UsersTable = () => {
  ...
  const paginatedUsers = useAccounts(users, page, rowsPerPage);
                  ...
                  <TableRow hover key={user._id} selected={isSelected}>
                    <TableCell padding='checkbox'>
                      <Checkbox
                        ...
                        onChange={(event) => {
                          if (event.target.checked) {
                            usersSelection.handleSelectOne(user._id);
                          } else {
                            usersSelection.handleDeselectOne(user._id);
                          }
                        }}
                      />
                    </TableCell>
